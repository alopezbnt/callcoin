...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/callcoin-project/callcoin>";
    const std::string URL_WEBSITE = "<https://callcoin.org>";
