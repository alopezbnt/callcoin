...
const char * const BITCOIN_CONF_FILENAME = "callcoin.conf";
const char * const BITCOIN_PID_FILENAME = "callcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "callcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/callcoin";
#else
    // Unix
    return pathRet / ".callcoin";
#endif
#endif
}
