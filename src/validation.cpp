...
#if defined(NDEBUG)
# error "callcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "callcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s CALLC additional fees, %d delta bytes\n",
