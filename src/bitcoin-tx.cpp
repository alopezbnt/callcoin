...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s callcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  callcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded callcoin transaction") + "\n" +
              "  callcoin-tx [options] -create [commands]   " + _("Create hex-encoded callcoin transaction") + "\n" +
              "\n";
