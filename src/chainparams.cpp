...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.callcoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.callcointools.com", true);
        vSeeds.emplace_back("dnsseed.callcoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.callcointools.com", true);
        vSeeds.emplace_back("seed-b.callcoin.loshan.co.uk", true);
