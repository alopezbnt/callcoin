callcoin Core version *0.15.1* is now available from:

  <https://download.callcoin.org/callcoin-0.15.1/>
...
A number of changes to the way callcoin Core deals with peer connections and invalid blocks
